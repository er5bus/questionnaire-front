              ...
              <Row className="align-items-center py-2">
                <Col lg="6">
                  <Breadcrumb className="breadcrumb-links breadcrumb-dark">
                    ...
                    <BreadcrumbItem active><i className="fas fa-pencil-alt"></i> Modifier responsables </BreadcrumbItem>
                  </Breadcrumb>
                </Col>
              </Row>
            </div>
...
export default connect(mapStateToProps, { editManager, fetchManager })(ManagerEdit)
