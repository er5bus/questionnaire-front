...
class Dashbord extends React.Component {
  ...
  onSubmit = (values) => {
    ...
    this.props.fetchDetailsOfTroubles(department, params)
  }
        ...
        <div className="header bg-primary pb-5">
          <Container fluid>
            <div className="header-body">
              <h6 className="h2 text-white d-inline-block mb-0 pt-4 ml-md-3"> Ergonomie </h6>
              <Row className="align-items-center py-2">
                <Col lg="6">
                  <Breadcrumb className="breadcrumb-links breadcrumb-dark">
                    <BreadcrumbItem active><i className="fas fa-home"></i> Ergonomie </BreadcrumbItem>
                  </Breadcrumb>
                </Col>
          ...
          <Row>
            <Col lg="12">
              <Card>
                ...
                <CardBody>
                  <FilterByDepartment departments={departments} initialValues={{ department: -1, company: this.props.user.company.id }} company={this.props.user.company.id} onSubmit={this.onSubmit} isLoading={isLoading} />
                </CardBody>
              </Card>
...
const mapStateToProps = state => ({ ...state.ergonomics, ...state.session })
