        ...
        <div className="header bg-primary pb-5">
          <Container fluid>
            <div className="header-body">
              <h6 className="h2 text-white d-inline-block mb-0 pt-4 ml-md-3"> Activités physiques </h6>
              <Row className="align-items-center py-2">
                <Col lg="6">
                  <Breadcrumb className="breadcrumb-links breadcrumb-dark">
                    <BreadcrumbItem active><i className="fas fa-home"></i> Activités physiques </BreadcrumbItem>
                  </Breadcrumb>
                </Col>
...
const mapStateToProps = state => ({ ...state.physical, ...state.session })
