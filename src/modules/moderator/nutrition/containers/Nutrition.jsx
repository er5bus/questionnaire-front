        ...
        <div className="header bg-primary pb-5">
          <Container fluid>
            <div className="header-body">
              <h6 className="h2 text-white d-inline-block mb-0 pt-4 ml-md-3"> Nutrition </h6>
              <Row className="align-items-center py-2">
                <Col lg="6">
                  <Breadcrumb className="breadcrumb-links breadcrumb-dark">
                    <BreadcrumbItem active><i className="fas fa-home"></i> Nutrition </BreadcrumbItem>
                  </Breadcrumb>
                </Col>
...
const mapStateToProps = state => ({ ...state.nutrition, ...state.session })
